...
@Component({
  ...
  template: `
    <div class="min-h-screen grid grid-cols-12 dark:bg-neutral-900 dark:text-neutral-100">
      <!-- Sidebar -->
      <aside class="col-span-12 sm:col-span-3 lg:col-span-2 border-b sm:border-b-0 sm:border-r border-gray-200 dark:border-neutral-800">
        <div class="p-4 sticky top-0">
          <a routerLink="/" class="text-2xl font-extrabold tracking-tight">🐦 TinyChirp</a>
        </div>
        <nav class="px-2 pb-4 space-y-1 text-[15px]">
      ...
      <div class="col-span-12 sm:col-span-9 lg:col-span-7">
        <header class="sticky top-0 z-10 bg-white/80 dark:bg-neutral-900/80 backdrop-blur border-b border-gray-200 dark:border-neutral-800">
        ...
        <main class="max-w-[820px] mx-auto p-4">
          <router-outlet></router-outlet>
        </main>
      </div>

      <!-- Right column / trends -->
      <aside class="hidden lg:block lg:col-span-3 border-l border-gray-200 dark:border-neutral-800 p-4">
